    ...
    <div class="cards card">
      <div class="cards-head">
        <div class="cards-info">
          <div class="calendar-hour" style="color: #868688;font-size: medium;font-weight: bold;margin-bottom: 3px">{{today.toLocaleTimeString()}}</div>
          <div class="degree" style="display: flex">
            ...
            <p style="margin-left: 10px;color: #c48181">{{quote}}</p>
          </div>
        </div>
