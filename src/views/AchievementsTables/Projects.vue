...
<script setup>
import {DeleteFilled,Delete,Document, Edit, EditPen,Plus, Search, UploadFilled, Refresh, Download,CircleClose} from '@element-plus/icons-vue'
...
//导出全部
const exportAll=()=>{
  window.location.href = "http://47.109.143.177:8080/Project/exportAll";
}
//批量导出
const exportPart=()=>{
