    ...
    <div style="margin-left: 2%">
      ...
      <div class="addInfo" style="margin-top: 10px;">
        ...
        >
          <el-form :model="formData" style="width: 80%" ref="rulesForm" :rules="rules" :inline="true">
            ...
            <el-form-item label="期刊/会议名" label-width="150" prop="jcName">
              <el-input v-model="formData.jcName" placeholder="期刊/会议名" clearable autocomplete="off"/>
            </el-form-item>
            ...
            <el-form-item label="作者位次" label-width="150" prop="place">
              <el-input v-model="formData.place" placeholder="填写一个数值即可(1表示为第一作者...)" clearable autocomplete="off"/>
            </el-form-item>
            <el-form-item label="作者位次" label-width="150" prop="allAuthors">
      ...
      <div class="table" style="width: 100%;margin-top: 0px ">
        <el-table v-loading="loading" :data="dataList" style="width: 120%" height="480" size="large"
          ...
          <el-table-column prop="title" label="论文标题" width="150">
          </el-table-column>
          <el-table-column prop="jcName" label="期刊/会议名称" width="150">
          </el-table-column>
          <el-table-column prop="publicDate" label="出版时间" width="120">
          </el-table-column>
          <el-table-column prop="issueNumber" label="期号" width="90">
          </el-table-column>
          <el-table-column prop="volumeNumber" label="卷号" width="90">
          </el-table-column>
          <el-table-column prop="pageRange" label="页码范围" width="100">
          </el-table-column>
          <el-table-column prop="place" label="作者位次" width="90">
          </el-table-column>
          <el-table-column prop="allAuthors" label="全部作者" width="180">
          </el-table-column>
          <el-table-column prop="searchType" label="检索类型" width="140">
          </el-table-column>
...
const rules = reactive({//校验规则
  ...
  jcName: [{required: true, message: '期刊/会议名必填', trigger: 'blur'}],
  issueNumber: [{required: true, message: '期刊/会议名必填', trigger: 'blur'}],
  publicDate: [{required: true, message: '必填项', trigger: 'blur'}],
  isNumber: [{required: true, message: '必填项', trigger: 'blur'}],
  volumeNumber: [{required: true, message: '必填项', trigger: 'blur'}],
  pageRange: [{required: true, message: '必填项', trigger: 'blur'}],
  place: [{required: true, message: '填入一个数字即可', trigger: 'blur'}],
  allAuthors: [{required: true, message: '必填项', trigger: 'blur'}],
  searchType: [{required: true, message: '必填项', trigger: 'blur'}],
  accessionNumber: [{required: true, message: '必填项', trigger: 'blur'}],
...
//导出全部
const exportAll = () => {
  window.location.href = "http://47.109.143.177:8080/ScientificPaper/exportAll";
}
//批量导出
const exportPart = () => {
