<!--<template>-->
<!--  <div id="chart-container" style="width: 100%; height: 100%; display: flex; justify-content: center; align-items: center;">-->
<!--    <div id="myReLi" style="width: 80%; height: 80%;"></div>-->
<!--  </div>-->
<!--</template>-->
...
<!--        calendarIndex: 0,-->
<!--        data: getVirtualData('2024') // 将初始数据替换为虚拟数据-->
<!--      }-->
<!--    ]-->
<!--  });-->
